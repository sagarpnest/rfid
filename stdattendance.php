...
<div class="sidebar close">
    ...
    <ul class="nav-links">
        ...
        <i c    lass='bx bxs-chevron-down arrow' ></i>
        </div>
        <ul class="sub-menu">
...
<div class="box">
    <form method="post" action="#">
        <input type="text" placeholder="Student id" id="id" name="id" required>
...
<table border="1px" align="center">
  ...
  <?php  
        ...
        $url =$link.$site.'get-student-attendance-data?college_id='.$id;
