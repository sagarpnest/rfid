...
<head>
    ...
    <!-- CSS -->
    <link href="building\css\building.css" rel="stylesheet" type="text/css" />
...
<input type="Text" placeholder="Building Id" name="bid"	>
    <input type="Text" placeholder="Building location" name="bname"	>
...
<?php
  ...
  if(isset($_REQUEST['save']) ){
    ...
    $url = $link . $site . "register/building?name=".$bid."&location=".$bname;
    ...
    if($res == 0){
        echo '<script>alert("Building has been registerred sucessfully")</script>';
    }else{
